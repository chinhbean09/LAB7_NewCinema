      ...
      <div className={`fixed-header ${darkMode ? 'dark-mode' : ''}`}>
        <Navbar expand="lg" className="bg-body-tertiary" style={{ padding: '0 0 ' }}>
          <Container fluid style={{ backgroundColor: 'white' }}>
            <Navbar.Brand className='brand ' href="/"><img className='logo' style={{ width: '60px', height: '60px', border: '3px solid black', borderRadius: '50px' }} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9aFYjjB4dk6d6ay7RDTsS7GjrHIqSoqz6Kw&usqp=CAU'></img></Navbar.Brand>
