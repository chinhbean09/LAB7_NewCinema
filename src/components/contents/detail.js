...
export default function Detail() {
    ...
    useEffect(() => {
        fetch(`https://654a0640e182221f8d525970.mockapi.io/films`)
    ...
    const Film = filmsData.find((obj) =>  obj.id == newid.id );
    console.log(Film)
    if (loading) {
    ...
    return (
        <>
            <div style={{ backgroundColor: 'rgb(19, 23, 34)', padding: '140px 0' }}>
                ...
                <iframe width="887" height="499" src={Film.link} title="Marvel Studios&#39; Avengers: Endgame - Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
